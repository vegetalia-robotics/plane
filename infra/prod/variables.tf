...
variable "data_volume_size_gb" { type = number, default = 100 }
variable "domain_name" { type = string, default = "" }
variable "hosted_zone_name" { type = string, default = "" }
variable "s3_lifecycle_ia_days" { type = number, default = 90 }
variable "s3_lifecycle_glacier_days" { type = number, default = 365 }
